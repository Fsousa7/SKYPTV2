...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      final exists = await DatabaseHelper.instance.nomeExists(_nome);
      if (exists) {
        setState(() {
          _error = "Nome de usuário já registrado";
          _success = null;
        });
        return;
      }
      try {
        ...
        await DatabaseHelper.instance.registerUserByNome(_nome, hashed);
        setState(() {
          _error = null;
